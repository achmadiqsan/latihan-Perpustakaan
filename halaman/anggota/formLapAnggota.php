...
<div id="page-wrapper" >
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h2>CETAK LAPORAN DATA ANGGOTA</h2>   
            </div>
        </div>
        <!-- /. ROW  -->
        <hr />
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <form role="form" method="GET" action="laporan/laporanAnggotaPeriode.php">
                            ...
                            <div>
                                ...
                                <a href="laporan/laporanAnggota.php" class="btn btn-success" target="_blank" > Cetak Semua</a>
